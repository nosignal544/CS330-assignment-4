...
public class ToolCreation implements ItemCreationStrategy
{
    ...
    public Item fromExisting(final Item original)
    {
    	...
    	Tool tool = (Tool) original;
    	Tool cpy = new Tool();
    	cpy.setName(tool.getName());
     	cpy.setMaterial(tool.getMaterial());
     	cpy.setDurability(tool.getDurability());
     	cpy.setSpeed(tool.getSpeed());
     	cpy.setModifier(tool.getModifier());
     	cpy.setModifierLevel(tool.getModifierLevel());
        return cpy;
    }
}
