...
public class ArmourCreation implements ItemCreationStrategy
{
    ...
    public Item fromTokens(final String... tokens)
    {
        ...
        // Set each attributethis.setName(tokens[0]);
    ...
    public Item fromExisting(final Item original)
    {
    	...
    	Armour armour = (Armour) original;
    	Armour cpy = new Armour();
    	cpy.setName(armour.getName());
        cpy.setMaterial(armour.getMaterial());
        cpy.setDurability(armour.getDurability());
        cpy.setDefense(armour.getDefense());
        cpy.setModifier(armour.getModifier());
        cpy.setModifierLevel(armour.getModifierLevel());
        cpy.setElement(armour.getElement());
