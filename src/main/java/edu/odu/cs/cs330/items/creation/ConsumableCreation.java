...
public class ConsumableCreation implements ItemCreationStrategy
{
    ...
    public Item fromExisting(final Item original)
    {
    	...
    	Consumable consumable = (Consumable) original;
    	Consumable cpy = new Consumable();
    	cpy.setName(consumable.getName());
    	cpy.setEffect(consumable.getEffect());
    	cpy.setNumberOfUses(consumable.getNumberOfUses());
        return cpy;
    }
}
